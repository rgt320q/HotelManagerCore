...
namespace DataAccess.Migrations
{
    ...
    [Migration("20210501110308_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("Entity.Concrete.BaseConfiguration", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AccommodationFee = 100m,
                            Active = true,
                            BreakfastPrice = 30m,
                            CompanyName = "Hotel Manager Core",
                            DailyAdultFee = 110m,
                            DailyChildFee = 60m,
                            DailyGuestFeeForRoom = 0m,
                            DinnerPrice = 50m,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 913, DateTimeKind.Local).AddTicks(5742),
                            LunchPrice = 35m,
                            TaxRateForAccommodation = 1m,
                            TaxRateForKDV = 18m,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 913, DateTimeKind.Local).AddTicks(5751)
                        });
                });
            ...
            modelBuilder.Entity("Entity.Concrete.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Dirty = false,
                            DoubleBed = (byte)0,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 911, DateTimeKind.Local).AddTicks(6663),
                            Name = "102",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)2,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(3682)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5425),
                            Name = "103",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5429)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5679),
                            Name = "104",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5681)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)0,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5684),
                            Name = "105",
                            PersonTotal = (byte)1,
                            Price1 = 80m,
                            SingleBed = (byte)1,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5685)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5687),
                            Name = "106",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5688)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5739),
                            Name = "107",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5740)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5742),
                            Name = "108",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5743)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5746),
                            Name = "109",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5747)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5748),
                            Name = "110",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5749)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            Dirty = false,
                            DoubleBed = (byte)1,
                            InsertDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5751),
                            Name = "101",
                            PersonTotal = (byte)2,
                            Price1 = 100m,
                            SingleBed = (byte)0,
                            UpdateDateTime = new DateTime(2021, 5, 1, 14, 3, 7, 912, DateTimeKind.Local).AddTicks(5752)
                        });
                });
